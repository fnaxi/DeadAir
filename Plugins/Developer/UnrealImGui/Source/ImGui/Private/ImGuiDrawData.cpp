...
#endif // ENGINE_COMPATIBILITY_LEGACY_CLIPPING_API
{
	...
	OutVertexBuffer.SetNumUninitialized(ImGuiVertexBuffer.Size, EAllowShrinking::No); // @ThirdPartyDA: 5.x uses EAllowShrinking instead of boolean value, it's still false the way
...
{
	// Reset buffer.
	OutIndexBuffer.SetNumUninitialized(NumElements, EAllowShrinking::No); // @ThirdPartyDA: 5.x uses EAllowShrinking
