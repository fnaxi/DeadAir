...
DECLARE_LOG_CATEGORY_EXTERN(X_Inventory, Log, All)
...
public:
	 ...
	 */
	bool IsFree(const FIntPoint& Coordinates, const UDA_InventoryItem* ItemToIgnore = nullptr);
	 ...
	 */
	bool DoesItemFit(TArray<FIntPoint> const& SizeInCells, const FIntPoint& Coordinates, const UDA_InventoryItem* ItemToIgnore = nullptr);
